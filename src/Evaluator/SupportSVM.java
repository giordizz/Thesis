...
public class SupportSVM {
	public static svm_parameter getParameters(int svmType, double wPos,
	...
	public static svm_model trainModel(int svmType, double wPos, double wNeg, svm_problem trainProblem,double gamma, double C) {
		svm_parameter param = getParameters(svmType, wPos, wNeg, gamma, C);
