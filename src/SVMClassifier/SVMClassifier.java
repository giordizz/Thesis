...
public class SVMClassifier {
	 ...
	 *  dove n � il numero di query che compongono il set considerato (o training o dev).
	 *  L'i-esimo elemento dell'array � "1" se la i-esima query del set � taggata con la categoria in esame, "0" altrimenti.
	*/ 
	 ...
	 * ogni riga del file identifica l'array di features di una specifica query nel formato "f1,f2,...fn" dove n � attualmente 123.
	 * <p/>
	 * Nei file di tipo "presence_cat-target*" sono presenti 2 righe per ogni categoria target (quindi in tutto ci sono 134 righe);
	 * La prima di queste due righe identifica il nome della categoria, la seconda �, invece, nel formato "B1	B2		BN" dove N � la dimensione del rispettivo set;
	 * il generico valore Bi � 1 se la i-esima query del set � taggata con la su detta categoria, 0 altrimenti.
	 * 
